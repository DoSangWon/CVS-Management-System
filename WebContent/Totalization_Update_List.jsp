...
Vector<TotalizationBean> vlist = mMgr.getTotalization();
	...
	for (int i = 0; i < vlist.size(); i++) {
				...
				out.println("<td align=center><a href='Totaization_Update_List_Forward.jsp?branch_Id="+bean.getTbid()+"&revenue="+bean.getTrevenue()+"&expenditure="+bean.getTexpenditure()+"&Tnum="+bean.getTnum()+"'>"+bean.getTnum() + "</a></td>");
