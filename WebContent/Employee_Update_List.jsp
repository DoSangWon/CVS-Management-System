...
<body>
<div id="page-wrapper" >
            <div id="page-inner"><form action="Employee_Update_Query_Forward.jsp" method="post">
                <div class="row">
                    <div class="col-md-12">
...
out.println("<center><table class='table table-striped table-bordered table-hover' border=2><thead>" + "<tr>" +"<td align=center>선택</td>"+ "<td align=center> 점원 ID </td>" +"<td align=center>성명</td>"+"<td align=center> 연락처 </td>" + "<td align=center> 생년월일 </td>" + "<td align=center> 시급(원) </td>" + "<td align=center> 지점 </td>" + "</tr></thead>");;
	...
	for (int i = 0; i < items.length; i++) {
		...
		out.println("<td align=center><input type=hidden name=eid value="+bean.getEid()+" style=border:0 >"+bean.getEid()+"</td>");
		...
		out.println("<td align=center><input type=text name=eName value="+bean.getEname()+" style=border:0 ></td>");
		out.println("<td align=center><input type=text name=etel value="+bean.getEtel()+" style=border:0 ></td>");
		out.println("<td align=center>"+bean.getEdate() + "</td>");
		out.println("<td align=center><input type=text name=ehw value="+bean.getEhw()+" style=border:0 ></td>");
